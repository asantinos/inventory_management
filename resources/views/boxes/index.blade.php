    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="w-full flex justify-between mb-8">
                ...
                <a href="{{ route('boxes.create') }}" class="flex items-center whitespace-nowrap rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none">Create Box</a>
            </div>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <table class="min-w-full w-full" id="items-table">
                        ...
                        <tbody>
                            ...
                            <tr class="item-row cursor-pointer hover:bg-gray-750">
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center space-x-2">
                                        <a href="{{ route('boxes.show', $box->id) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 focus:outline-none focus:underline">Show</a>
                                        ...
                                        <a href="{{ route('boxes.destroy', $box->id) }}" class="text-red-600 dark:text-red-400 hover:text-red-500 dark:hover:text-red-300 focus:outline-none focus:underline">Delete</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
